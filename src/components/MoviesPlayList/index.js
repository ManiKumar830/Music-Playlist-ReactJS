...
class MoviesPlayList extends Component {
  ...
  renderNoSongsView = () => (
    <div className="no-songs-container">
      <p className="songs-text">No Songs Found</p>
    </div>
  )

  onClickDeleteItem = id => {
    const {playlist} = this.state
    const updatedPlaylist = playlist.filter(eachItem => eachItem.id !== id)
      ...
      <div className="bg">
        ...
        <div className="bottom-container">
          <div className="playlist-container">
            <h1 className="playlist-text">Songs Playlist</h1>
